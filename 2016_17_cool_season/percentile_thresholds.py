...
plt.ylabel('Absolute Event Threshold (mm)', fontsize = 19)
plt.xlabel('Percentile Event Threshold', fontsize = 19)
props = dict(boxstyle='square', facecolor='white', alpha=1)
fig1.text(0.077, 0.93, '(a) Pacific Ranges', fontsize = 19, bbox = props)
plt.xlim([50,95.1])
plt.ylim([0,55])
...
plt.grid(True)
props = dict(boxstyle='square', facecolor='white', alpha=1)
fig1.text(0.558,0.93, '(b) Interior Ranges', fontsize = 19, bbox = props)
plt.xlabel('Percentile Event Threshold', fontsize = 19)
plt.ylim([0,55])
plt.xticks(np.arange(5,96,5))
ax1.set_xticklabels(np.arange(5,96,5), fontsize = 14)
...
plt.xlim([50,95])
plt.tight_layout()
plt.legend(handles=[ black, blue,  red, cyan,green, gold, magenta], loc='upper left', bbox_to_anchor=(-1.12, 0.923), 
           ncol=1, fontsize = 13)
