...
fig1=plt.figure(num=None, figsize=(17,12), dpi=500, facecolor='w', edgecolor='k')
fig1.subplots_adjust(hspace=.2, bottom = 0.17)
...
for i in range(4):
    ...
    if i == 0: 
        plt.title('Equitable Threat Score', fontsize = 22)
        ax1.text(7, .405, 'Pacific', fontsize = 25, bbox = props)
        t = 6*i+6 
        plt.gca().set_color_cycle(linecolor)
        ax1.plot(x,ets[:,6*i:t], linewidth = 2, marker = "o", markeredgecolor = 'none')
    ...
    if i == 1:
        ...
        ax1.text(7, 1.64, 'Pacific', fontsize = 25, bbox = props)
        plt.gca().set_color_cycle(linecolor)
        ax1.plot(x,bias[:,0:6],linewidth = 2,marker = "o", markeredgecolor = 'none')
        
    if i == 2:
        ax1.text(7, .36, 'Interior', fontsize = 25, bbox = props)
        i = i - 1
        t = 6*i+6 
        plt.gca().set_color_cycle(linecolor)
        ax1.plot(x,ets[:,6*i:t], linewidth = 2, marker = "o", markeredgecolor = 'none')
    ...
    if i == 3:
        ax1.text(7, 1.64, 'Interior', fontsize = 25, bbox = props)
        plt.gca().set_color_cycle(linecolor)
        ax1.plot(x,bias[:,6:12],linewidth = 2,marker = "o", markeredgecolor = 'none')
...
plt.legend(handles=[ blue, green, red, cyan, gold, magenta], loc='upper center', bbox_to_anchor=(-.12, -0.12), 
           ncol=3, fontsize = 16)
#plt.tight_layout()
plt.savefig('ets_bias_score_regional_interp_2016_17.pdf')
plt.show()
