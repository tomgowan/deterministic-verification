                        ...
                        if ncar_data[x,0] == inhouse_data[y,0]:
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  inhouse_data[y,z] < 1000:
                                    ...
                                    if ncar_data[x,z] >= percentile_f and inhouse_data[y,z] >= percentile:
                                        hit[s,u] = hit[s,u] + 1
                        ...
                        if ncar_data[x,0] == inhouse_data[y,0]:
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  inhouse_data[y,z] < 1000:
                                    ...
                                    if gfs_data[x,z] >= percentile_f and inhouse_data[y,z] >= percentile:
                                        hit[s,u] = hit[s,u] + 1
                        ...
                        if hrrr_data[x,0] == inhouse_data[y,0]:
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  inhouse_data[y,z] < 1000:
                                    ...
                                    if hrrr_data[x,z] >= percentile_f and inhouse_data[y,z] >= percentile:
                                        hit[s,u] = hit[s,u] + 1
                        ...
                        if nam_data[x,0] == inhouse_data[y,0]:
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  inhouse_data[y,z] < 1000:
                                    ...
                                    if nam_data[x,z] >= percentile_f and inhouse_data[y,z] >= percentile:
                                        hit[s,u] = hit[s,u] + 1
                        ...
                        if sref_arw_data[x,0] == inhouse_data[y,0]:
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  inhouse_data[y,z] < 1000:
                                    ...
                                    if sref_arw_data[x,z] >= percentile_f and inhouse_data[y,z] >= percentile:
                                        hit[s,u] = hit[s,u] + 1
                        ...
                        if sref_nmb_data[x,0] == inhouse_data[y,0]:
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  inhouse_data[y,z] < 1000:
                                    ...
                                    if sref_nmb_data[x,z] >= percentile_f and inhouse_data[y,z] >= percentile:
                                        hit[s,u] = hit[s,u] + 1
