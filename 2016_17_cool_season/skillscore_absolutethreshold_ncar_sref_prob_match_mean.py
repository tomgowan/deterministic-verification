            ...
            if w == 0:
                    if ((regions[0,0] <= data[1,x,1] <= regions[0,1] and regions[0,2] <= data[1,x,2] <= regions[0,3]) or ###Sierra Nevada
                        ...
                        if data[1,x,0] == data[0,y,0]:
                            ...
                            gfs_pac = np.append(gfs_pac, data[2,x,3:185])
                            hrrr_pac = np.append(hrrr_pac, data[3,x,3:185])
                            nam_pac = np.append(nam_pac, data[4,x,3:185])
                            sref_arw_pac = np.append(sref_arw_pac, data[5,x,3:185])
                            sref_nmb_pac = np.append(sref_nmb_pac, data[6,x,3:185])
                            ncar_mean_pac = np.append(ncar_mean_pac, data[7,x,3:185])
                            ncar_prob_match_mean_pac = np.append(ncar_prob_match_mean_pac, data[8,x,3:185])
            ...
            if w == 1:
                    if ((regions[2,0] <= data[1,x,1] <= regions[2,1] and regions[2,2] <= data[1,x,2] <= regions[2,3]) or ## CO Rockies
                        ...
                        if data[1,x,0] == data[0,y,0]:
                            ...
                            gfs_int = np.append(gfs_int, data[2,x,3:185])
                            hrrr_int = np.append(hrrr_int, data[3,x,3:185])
                            nam_int = np.append(nam_int, data[4,x,3:185])
                            sref_arw_int = np.append(sref_arw_int, data[5,x,3:185])
                            sref_nmb_int = np.append(sref_nmb_int, data[6,x,3:185])
                            ncar_mean_int = np.append(ncar_mean_int, data[7,x,3:185])
                            ncar_prob_match_mean_int = np.append(ncar_prob_match_mean_int, data[8,x,3:185])
...
#                                                      
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  data[0,y,z] < 1000:
                                    ...
                                    if data[1,x,z] >= abs_thres[s] and data[0,y,z] >= abs_thres[s]:
                                        hit[s,u] = hit[s,u] + 1
...
#                            
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  data[0,y,z] < 1000:
                                    ...
                                    if data[2,x,z] >= abs_thres[s] and data[0,y,z] >= abs_thres[s]:
                                        hit[s,u] = hit[s,u] + 1
...
#                            
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  data[0,y,z] < 1000:
                                    ...
                                    if data[3,x,z] >= abs_thres[s] and data[0,y,z] >= abs_thres[s]:
                                        hit[s,u] = hit[s,u] + 1
...
#                            percentile_f = np.percentile(p_array_f,percent)
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  data[0,y,z] < 1000:
                                    ...
                                    if data[4,x,z] >= abs_thres[s] and data[0,y,z] >= abs_thres[s]:
                                        hit[s,u] = hit[s,u] + 1
...
#                            
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  data[0,y,z] < 1000:
                                    ...
                                    if data[5,x,z] >= abs_thres[s] and data[0,y,z] >= abs_thres[s]:
                                        hit[s,u] = hit[s,u] + 1
...
#                            
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  data[0,y,z] < 1000:
                                    ...
                                    if data[6,x,z] >= abs_thres[s] and data[0,y,z] >= abs_thres[s]:
                                        hit[s,u] = hit[s,u] + 1
...
#                            
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  data[0,y,z] < 1000:
                                    ...
                                    if data[7,x,z] >= abs_thres[s] and data[0,y,z] >= abs_thres[s]:
                                        hit[s,u] = hit[s,u] + 1
...
#                            
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  data[0,y,z] < 1000:
                                    ...
                                    if data[8,x,z] >= abs_thres[s] and data[0,y,z] >= abs_thres[s]:
                                        hit[s,u] = hit[s,u] + 1
...
#                            
                            ...
                            for z in range(3,185):
                                ...
                                if all(data[1:,x,z] < 1000) and  data[0,y,z] < 1000:
                                    ...
                                    if data[9,x,z] >= abs_thres[s] and data[0,y,z] >= abs_thres[s]:
                                        hit[s,u] = hit[s,u] + 1
...
plt.legend(handles=[lightblue, blue, darkblue, lightgreen, mediumseagreen, darkgreen, lightcoral, red,  darkred], loc='upper center', bbox_to_anchor=(-0.10, -0.21), 
           ncol=3, fontsize = 18)
plt.savefig("../../../public_html/ms_thesis_plots/categorical_scores_absoluteforecasts_interp_regional_2016_17_ncar_sref_PM.pdf")
plt.close(fig1)
